DROP PROCEDURE IF EXISTS `init_dbs()`;
 ...
 BEGIN
    ...
    START TRANSACTION;
	 ...
	 INSERT INTO user (user_id, email, pwd, name, first_name) VALUES 
		(1, 'mrace_33', 'karel.kk@gmail.com', '1234','Mracek', 'Karel'),
		(2, 'brown_77', 'bbbb@gmail.com', '5678','Brown', 'Barbsina');
	 ...
	 #users, students
	 INSERT INTO user (user_id, email, pwd, name, first_name) VALUES 
		(3, 'pavko_00', 'annak@outlook.com', 'abcd','Pavkova', 'Anna'),
		(4, 'centa_01', 'centaj@gmail.com', '1234','Centa', 'Juan'),
		(5, 'juand_15', 'love.me.tender@gmail.com', '1234','Juan', 'Don'),
		(6, 'prass_13', 'vagararar@gmail.com', '1234','Prassad', 'Vagarandra'),
		(7, 'bobes_40', 'l.maupa@seznam.cz', '5678','Bobes', 'Loraine'),
		(8, 'chuet_01', 'karel.kk@gmail.com', '1234','Chuette', 'Ninoska');
	 ...
	 INSERT INTO evaluation (evaluation_id,scheduled_at, ending_at, nb_minutes, class_id, trainer_id, quiz_id, completed_at)  VALUES 
		(1,'2017-06-25 16:03:34','2018-06-30 16:03:34',60, 1, 1, '2018-06-30 16:03:34'), 
		(2,'2017-06-15 16:03:34','2018-06-20 16:03:34',60, 1, 1, '2018-06-21 16:03:34');
	 ...
	 #sql-question
	INSERT INTO sql_question (question_id, quiz_text, correct_answer) VALUES 
