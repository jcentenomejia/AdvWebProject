...
class EvaluationModel {
    ...
    public static function getEvaluation($evaluationId) {
        ...
        $sql = "select evaluation_id,scheduled_at, nb_minutes,nb_minutes,fx_real_min(:eval_id) as real_nb_minutes, quiz.title,class.name as class_name, concat(user.first_name, ' ',user.name) as trainer from evaluation as eval
